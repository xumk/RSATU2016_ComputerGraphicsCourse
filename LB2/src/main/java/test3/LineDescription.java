...
public class LineDescription {
    ...
    public LineDescription(int startPositionX, int startPositionY, int endPositionX, int endPositionY, Color color) {
        ...
        this.startPositionX = startPositionY;
        this.endPositionY = endPositionY;
        this.color = color;
    }

    public LineDescription(Point2D p1, Point2D p2, Color color) {
        this.startPositionX = (int) p1.getX();
        this.endPositionX = (int) p2.getX();
        this.startPositionY = (int) p1.getY();
        this.endPositionY = (int) p2.getY();
        this.color = color;
    }
